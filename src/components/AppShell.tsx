        ...
        {drawerOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 z-[70] w-[82%] max-w-xs border-l border-border/50 bg-card/95 backdrop-blur-2xl"
            ...
            >
              ...
              <div className="flex items-center justify-between p-5 border-b border-border/50">
                <div className="flex items-center gap-2.5">
                  <AppLogo size="sm" />
                  <span className="font-heading font-bold text-base">Syllabix<sup className="text-[0.6em]">NG</sup></span>
                </div>
                <button
                  onClick={() => setDrawerOpen(false)}
              ...
              <div className="overflow-y-auto h-[calc(100%-72px)] px-3 py-4 space-y-5">
                ...
                <div className="pt-4 px-3 border-t border-border/30">
                  <p className="text-[10px] text-muted-foreground/60">Syllabix<sup>NG</sup> v2.0</p>
                </div>
              </div>
            </motion.div>
          </>
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between px-4 py-3 border-b border-border/50 bg-card/90 backdrop-blur-xl">
      <div className="flex items-center gap-2">
        <AppLogo size="sm" />
        <h1 className="text-lg font-heading font-bold text-foreground">Syllabix<sup className="text-[0.6em]">NG</sup></h1>
      </div>
      <OnlineIndicator />
    </header>
  );
